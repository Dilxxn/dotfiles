...
keys = [
    ...
    Key([mod, alt], "1",
        ...
        lazy.spawn("cp /home/(user)/.config/alacritty/themes/MonokaiPro/alacritty.yml /home/(user)/.config/alacritty"),
    	lazy.spawn("cp /home/(user)/.local/share/rofi/themes/themes/MonokaiPro/onedark.rasi /home/(user)/.local/share/rofi/themes"),
        lazy.restart(),
    	),
    ...
    Key([mod, alt], "2",
        ...
        lazy.spawn("cp /home/(user)/.config/alacritty/themes/MaterialOcean/alacritty.yml /home/(user)/.config/alacritty"),
    	lazy.spawn("cp /home/(user)/.local/share/rofi/themes/themes/MaterialOcean/onedark.rasi /home/(user)/.local/share/rofi/themes"),
        lazy.restart(),
        ),
    ...
    Key([mod, alt], "3",
        ...
        lazy.spawn("cp /home/(user)/.config/alacritty/themes/Rosepine/alacritty.yml /home/(user)/.config/alacritty"),
    	lazy.spawn("cp /home/(user)/.local/share/rofi/themes/themes/Rosepine/onedark.rasi /home/(user)/.local/share/rofi/themes"),
        lazy.restart(),
    	),
    ...
    Key([mod, alt], "4",
        ...
        lazy.spawn("cp /home/(user)/.config/alacritty/themes/DarkGrey/alacritty.yml /home/(user)/.config/alacritty"),
    	lazy.spawn("cp /home/(user)/.local/share/rofi/themes/themes/DarkGrey/onedark.rasi /home/(user)/.local/share/rofi/themes"),
        lazy.restart(),
    	),
    ...
    Key([mod, alt], "4",
    	...
    	lazy.spawn("cp /home/(user)/.local/share/rofi/themes/themes/DistroTube/onedark.rasi /home/(user)/.local/share/rofi/themes"),
        lazy.restart(),
    	),
    ...
    Key([alt], "F7", lazy.spawn("playerctl stop")),
